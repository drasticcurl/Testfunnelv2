      ...
      >
        ...
        <motion.div variants={item}>
          <Link
            ...
            className="block bg-gradient-to-r from-sage-soft/50 to-sage-soft/20 rounded-2xl p-5 border border-sage/15 hover:border-sage/30 transition-colors group"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-sage-soft flex items-center justify-center shrink-0">
