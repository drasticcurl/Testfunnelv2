...
function StepBienvenida({ nombre, onNext }: { nombre: string; onNext: () => void }) {
  return (
    <div className="text-center space-y-6">
      <div>
        <p className="text-charcoal/60 text-sm mb-1">Bienvenida a tu protocolo</p>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-sand/20 text-left space-y-4">
        <p className="text-charcoal/80 text-sm leading-relaxed">
          Estás a un paso de empezar tu Protocolo Anti-Hinchazón.
        </p>
        ...
        <div className="bg-sage-soft/40 rounded-xl p-4 mt-3">
          ...
          <ul className="text-xs text-charcoal/70 space-y-1.5 mt-2">
            <li>✓ Plan diario de 30 días</li>
            <li>✓ Recetas antiinflamatorias adaptadas</li>
            <li>✓ Diario de síntomas con gráficos</li>
            <li>✓ Calculadora de microbiota</li>
      ...
      <button
        onClick={onNext}
        className="w-full py-3.5 px-6 bg-sage text-white font-semibold rounded-full hover:bg-sage/90 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
      >
        Empecemos →
      </button>
    </div>
...
function StepTour({ onNext }: { onNext: () => void }) {
  return (
    <div className="space-y-6">
      ...
      <button
        onClick={onNext}
        className="w-full py-3.5 px-6 bg-coral text-white font-semibold rounded-full hover:bg-coral/90 transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
      >
