    ...
    <div className="space-y-6 pb-24">
      ...
      <div>
        <button
          ...
          className="text-sm font-medium mb-3 flex items-center gap-1 hover:opacity-80 transition-opacity"
        ...
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: 'var(--terracotta-soft)' }}>
            <span className="font-bold text-lg" style={{ color: 'var(--terracotta)' }}>{dayNumber}</span>
          </div>
          <div>
      ...
      <div className="rounded-2xl p-4 border" style={{ backgroundColor: 'var(--terracotta-soft)', borderColor: 'rgba(192,85,58,0.2)' }}>
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide mb-1" style={{ color: 'var(--terracotta)' }}>
              Tip del día
            </p>
        ...
        <div className="fixed bottom-20 left-0 right-0 px-4 z-10">
          <div className="max-w-md mx-auto">
            <button
              ...
              className="w-full text-white font-semibold text-sm py-3.5 rounded-full shadow-lg hover:opacity-90 transition-all active:scale-[0.98]"
      ...
      {isCompleted && !justCompleted && (
        <div className="rounded-2xl p-3 text-center border" style={{ backgroundColor: 'var(--terracotta-soft)', borderColor: 'rgba(192,85,58,0.2)' }}>
