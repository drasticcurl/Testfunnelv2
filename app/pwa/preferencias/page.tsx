...
export default function PreferenciasPage() {
  ...
  return (
    <div className="pb-24 space-y-6">
      ...
      <button
        onClick={handleSave}
        className={`w-full py-3.5 px-6 font-semibold rounded-full transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5 text-white`}
        style={{ background: saved ? 'rgba(192,85,58,0.75)' : 'linear-gradient(135deg, var(--terracotta), var(--terracotta-light))' }}
      >
