...
// Las imágenes son 4 (edad-25-34, edad-35-44, edad-45-54, edad-55-mas) y los
// rangos visibles del quiz también son 4 (18-29 / 30-39 / 40-54 / 55+). Los
// mapeamos en orden, por value, para que el avatar siga al rango aunque los
// labels numéricos no coincidan exactamente con el nombre del archivo.
const AGE_IMAGES: Record<string, string> = {
  '18_29': '/img/edad-25-34.png',
  '30_39': '/img/edad-35-44.png',
  '40_54': '/img/edad-45-54.png',
