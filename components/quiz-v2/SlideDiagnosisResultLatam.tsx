...
/**
 * SlideDiagnosisResultLatam — fork neutro (español "tú") de SlideDiagnosisResult.
 * Misma estructura/estilo/props. El copy visible ya era neutral; se mantiene.
 * Reutiliza los helpers compartidos (diagnóstico, descripciones, urgencia).
 */
export function SlideDiagnosisResultLatam({ onNext }: Props) {
