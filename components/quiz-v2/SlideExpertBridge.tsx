...
export function SlideExpertBridge({ onNext }: Props) {
      ...
      <div className="w-full max-w-sm mx-auto flex flex-col items-center text-center gap-6">
        ...
        <div>
          ...
          <p className="text-sm mt-2" style={{ color: 'var(--muted)', fontFamily: 'var(--font-sans)' }}>
            Creadora del Método del Agua de Arroz · Podés ajustar tus objetivos durante el diagnóstico
          </p>
        </div>
        ...
        >
          ...
          <div className="relative">
            ...
            {/* Badge dorado */}
            <span
              className="absolute -bottom-1 -right-1 text-xs font-bold px-2 py-0.5 rounded-full border-2 border-white"
          ...
          <div className="w-full flex flex-col gap-3 text-left">
            <div className="flex items-start gap-3">
              ...
              <p className="text-xs leading-relaxed" style={{ color: 'var(--muted)', fontFamily: 'var(--font-sans)' }}>
                Especialista en Nutrición y Metabolismo Femenino por la Universidad de Buenos Aires (UBA), con aportes académicos para la Sociedad Argentina de Nutrición (SAN) sobre el impacto de la inflamación intestinal en la calidad de vida de las mujeres.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-xl flex-shrink-0">🌍</span>
