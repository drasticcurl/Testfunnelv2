...
/**
 * SlideLandingHookLatam — fork neutro (español "tú") de SlideLandingHook.
 * Misma estructura/estilo/props. Copy neutralizado: vos→tú, panza→barriga,
 * sin referencias argentinas (matrícula MN, "argentinas").
 */
export function SlideLandingHookLatam({ onNext }: Props) {
  return (
    <motion.div
    ...
    >
      <div className="w-full max-w-sm mx-auto flex flex-col items-center text-center gap-5">
        ...
        >
          Descubre el método del agua de arroz que está{' '}
        ...
        >
          ¿Sientes la barriga hinchada, te cuesta bajar de peso o tu metabolismo está cada vez más lento?
        </p>
                ...
                el.parentElement.innerHTML = `
                  <div style="padding:24px;background:#FFF5F0;display:flex;flex-direction:column;gap:12px;align-items:center;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:6px;text-align:left;width:100%;">
                      ...
                      <p style="font-size:12px;color:#5A6072;">✓ Deshinchar la barriga sin dieta</p>
        ...
        <p
          ...
          style={{ color: 'var(--muted)', fontFamily: 'var(--font-sans)' }}
        >
          Responde este diagnóstico rápido y descubre cómo el agua de arroz puede ayudarte a{' '}
