...
/**
 * SlideLoadingStepsLatam — fork neutro (español "tú") de SlideLoadingSteps.
 * Misma estructura/estilo/props. El copy ya era neutral; se mantiene.
 */
export function SlideLoadingStepsLatam({ onComplete }: Props) {
