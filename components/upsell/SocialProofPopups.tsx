...
/**
 * SocialProofPopups — burbujas de COMPRA en vivo que aparecen mientras corre el
 * VSL en /upsell.
 *
 * Objetivo (pedido del cliente): mientras la persona mira el video, tiene que
 * VER que otra gente está COMPRANDO el Programa TURBO ahora mismo. Genera FOMO
 * + validación social ("si todos lo compran, debe funcionar / me lo voy a
 * perder").
 *
 * Diferencia vs versión anterior: antes decía "vio el video hace N min"; ahora
 * dice "acaba de asegurar/compró el Programa TURBO", con tilde verde de compra
 * verificada y rotación MÁS SEGUIDA (más agresivo, ya compraron el front).
 *
 * Es puramente visual (no envía tracking). Aparece una burbuja a la vez,
 * esquina inferior izquierda, con animación de entrada/salida. Respeta
 * prefers-reduced-motion vía las utilidades de Tailwind (transition).
 */
...
const NOMBRES = [
  ...
  'Martina', 'Julieta', 'Carla', 'Agustina', 'Rocío', 'Belén',
  'Daniela', 'Micaela', 'Antonella', 'Brenda', 'Romina', 'Paula',
  'Gabriela', 'Verónica', 'Natalia', 'Yamila', 'Abril', 'Renata',
];

const CIUDADES = [
  'La Plata', 'Tucumán', 'Córdoba', 'Rosario', 'Mendoza', 'CABA',
  'Mar del Plata', 'Salta', 'Santa Fe', 'San Juan', 'Neuquén', 'Posadas',
  'Bahía Blanca', 'Quilmes', 'Lanús', 'Paraná', 'Corrientes', 'Resistencia',
];
