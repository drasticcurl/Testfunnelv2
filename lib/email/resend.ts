...
<table width="100%" style="max-width:520px;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #EFECE7;">
  ...
  <tr><td style="padding:32px;">
    ...
    <p style="text-align:center;margin:24px 0;">
      <a href="${process.env.NEXT_PUBLIC_SITE_URL || 'https://anti-hinchazon.com'}/resultados" style="display:inline-block;background:#E07856;color:#fff;padding:14px 32px;border-radius:8px;text-decoration:none;font-size:16px;font-weight:600;">
