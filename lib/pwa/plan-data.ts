...
export const PLAN_DATA: DayPlan[] = [
  // ═══════════════════════════════════════════════════════════
  // SEMANA 1 — Limpieza y desinflamación (Días 1-7)
  // ═══════════════════════════════════════════════════════════
  {
    day: 1,
    title: 'Empezamos suave',
    subtitle: 'Primer día del protocolo antiinflamatorio',
    meals: [
      {
        moment: 'Desayuno',
        emoji: '🌅',
    ...
    tip: 'Sí o sí: vaso de agua tibia con limón en ayunas. Y caminá 10 minutos después de almorzar y después de cenar. No te saltees esto.',
