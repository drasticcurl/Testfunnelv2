...
/**
 * Quiz Corto (Google Ads) — 10 interacciones + loading/resultado/plan/sales
 * Alto intent, directo. Solo 1 social proof para no fatigar.
 * Estructura: Perfil (5) → Hábitos (3) → Cierre (2) → Resultado → Sales
 */
export const slidesCorto: SlideDefinition[] = [
  // === SECCIÓN 1: Tu perfil de sueño (0-4) ===
  {
    id: 'genero',
    type: 'gender',
  ...
  // === SECCIÓN 2: Hábitos y causas (5-8) ===
  {
    id: 'pantalla',
    type: 'single',
  ...
  // === SECCIÓN 3: Cierre y resultado (9-13) ===
  {
    id: 'compromiso',
    type: 'single',
